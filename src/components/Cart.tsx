...
//   // UPDATED LOGIC: Extract only the price before the '/'
//   const getNumericPrice = (priceString: string) => {
//     // Splits "₹300 / 200g" into ["₹300 ", " 200g"] and takes the first part
//     const pricePart = priceString.split('/')[0];
//     // Removes non-numeric characters (like ₹) to get just "300"
//     return parseInt(pricePart.replace(/[^0-9]/g, "")) || 0;
//   };
...
//     return (
//       <div className="floating-cart rounded-2xl p-4 shadow-2xl border border-primary/20 bg-warm-darker/90 backdrop-blur-md" onClick={onClose}>
...
//               handleWhatsAppOrder();
//             }}
//             className="bg-[#25D366] text-white px-4 py-2 rounded-xl flex items-center gap-2 text-xs font-bold"
//           >
...
//             <p className="text-xs text-muted-foreground">{totalItemsCount} items selected</p>
//           </div>
...
//               <button onClick={onClose} className="mt-4 text-primary font-bold hover:underline">Browse Menu</button>
//             </div>
//           ) : (
//             cartItems.map((item) => (
...
//                         className="w-6 h-6 rounded-md bg-white/5 flex items-center justify-center hover:bg-primary transition-colors"
//                       >
